...
public class OI {
    ...
    public OI() {
        ...
        buttonB = new JoystickButton(driveController, 0);
    ...
    public double getJoyX(Hand side) {
    	double joyX = driveController.getX(side);
    	return joyX;
    }
    
    public double getJoyY(Hand side) {
    	double joyY = driveController.getY(side);
    	return joyY;
    }
