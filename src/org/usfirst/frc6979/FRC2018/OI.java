...
public class OI {
    ...
    public XboxController alternateController;
    ...
    public OI() {
        ...
        alternateController = new XboxController(1);
    ...
    public XboxController getAlternateController() {
    ...
    public boolean getButtonX2() {
    	boolean joyX = alternateController.getXButton();
    	return joyX;
    }
    
    public boolean getButtonY2() {
    	boolean joyY = alternateController.getXButton();
    	return joyY;
    }
    
    public boolean getDpadRight() {
    	final int direction = alternateController.getPOV();
